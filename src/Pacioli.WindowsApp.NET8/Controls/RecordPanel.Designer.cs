namespace Pacioli.WindowsApp.NET8.Controls
{
    partial class RecordPanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            F_TablePanel.Controls.Add(F_FileNameTb, 1, 2);
            ...
            F_TablePanel.RowCount = 3;
            F_TablePanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 50F));
            F_TablePanel.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
            F_TablePanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 60F));
            ...
            F_FileNameTb.Location = new Point(47, 1106);
            ...
            F_FileNameTb.Size = new Size(1611, 52);
            ...
            flowLayoutPanel2.Size = new Size(319, 1046);
